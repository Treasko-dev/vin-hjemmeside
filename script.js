const products = [
  ...
  {
    name: 'Cerasuolo d’Abruzzo Rosato',
    category: 'rosé',
    country: 'Italien',
    region: 'Abruzzo',
    year: 2022,
  ...
  {
    name: 'Etna Rosato Pietra Lavica',
    category: 'rosé',
    country: 'Italien',
    region: 'Sicilien',
    year: 2022,
    ...
    price: 169,
    outlet: false,
    description: 'Vulkansk mineralitet, hvide kirsebær og blodappelsin. Ganske tør og præcis.',
  ...
  },
  {
    ...
    price: 95,
    outlet: false,
    description: 'Fersken, hindbær og frisk syre fra Syditalien. Lækker til antipasti.',
    image: 'https://images.unsplash.com/photo-1506377872008-397fd055263f?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Chiaretto Spumante Rosé',
    category: 'rosé',
    country: 'Italien',
    region: 'Lombardiet',
    year: 2021,
    ...
    price: 139,
    outlet: false,
    description: 'Perlende rosé med ribs, hvid peber og fine bobler. Festlig aperitif.',
    image: 'https://images.unsplash.com/photo-1584466977773-e625c37cdd50?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Maremma Toscana Rosato',
    category: 'rosé',
    country: 'Italien',
    region: 'Toscana',
    year: 2022,
    ...
    price: 125,
    outlet: false,
    description: 'Saftig toscansk rosé med vilde jordbær, rosenblade og livlig syre.',
